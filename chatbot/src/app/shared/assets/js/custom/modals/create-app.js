/******/ ;(() => {
  ...
  /*!******************************************************************************!*\
  !*** ../../../themes/metronic/html/demo2/src/js/custom/modals/create-app.js ***!
  \******************************************************************************/
  ...
  var KTCreateApp = (function () {
    ...
    var initStepper = function () {
      ...
      stepperObj.on('kt.stepper.changed', function (stepper) {
        ...
        if (stepperObj.getCurrentStepIndex() === 10) {
          formSubmitButton.classList.remove('d-none')
          formSubmitButton.classList.add('d-inline-block')
          formContinueButton.classList.add('d-none')
        } else if (stepperObj.getCurrentStepIndex() === 11) {
    ...
    return {
      ...
      init: function () {
        ...
        modalStoryEl = document.querySelector('#kt_modal_story')
        if (!modalEl) {
          return
        }

        modal = new bootstrap.Modal(modalEl);
		modalStory = new bootstrap.Modal(modalStoryEl);
